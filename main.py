...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://wallpapers.com/images/high/sea-background-brm1xis4tk85vgdn.webp");
        ...
        try:
            if predict:
                with st.spinner('Getting Price'):
                    with open("C:/Users/gokul/Music/singapore_prediction/Resale_flat_price.pkl",'rb') as f:
                        model = pickle.load(f)
                    with open("C:/Users/gokul/Music/singapore_prediction/town_ohe.pkl", 'rb') as f:
                        town_ohe = pickle.load(f)
                    with open("C:/Users/gokul/Music/singapore_prediction/flat_type_ohe.pkl",'rb') as f:
                        flat_type_ohe = pickle.load(f)
                    with open("C:/Users/gokul/Music/singapore_prediction/storey_range_ohe.pkl",'rb') as f:
                        storey_range_ohe = pickle.load(f)
                    with open("C:/Users/gokul/Music/singapore_prediction/flat_model_ohe.pkl",'rb') as f:
                        flat_model_ohe = pickle.load(f)
                    with open("C:/Users/gokul/Music/singapore_prediction/Resale_flat_scaler.pkl",'rb') as f:
